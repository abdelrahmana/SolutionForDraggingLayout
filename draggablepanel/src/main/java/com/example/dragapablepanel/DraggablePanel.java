...
public class DraggablePanel extends FrameLayout {
  ...
  private DraggableViews draggableView;
  ...
  public void initializeView() {
    ...
    draggableView = (DraggableViews) findViewById(R.id.draggable_view);
  ...
  private void initializeAttrs(AttributeSet attrs) {
    ...
    this.xScaleFactor =
        attributes.getFloat(R.styleable.draggable_panel_x_scale_factors, DEFAULT_SCALE_FACTOR);
    this.yScaleFactor =
        attributes.getFloat(R.styleable.draggable_panel_y_scale_factors, DEFAULT_SCALE_FACTOR);
